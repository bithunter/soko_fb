    ...
    var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
        ...
        a = (function(t) {
                ...
                f = function() {
                    ...
                    return e.prototype.toggle = function() {
                        ...
                        if (i) {
                            ...
                            if (o) {
                                if ("radio" === o.type)
                                    if (o.checked && t(this._element).hasClass(h.ACTIVE))
                                        e = !1;
                                    else {
                ...
                I = function() {
                    ...
                    return c.prototype.next = function() {
                        ...
                        var i = this,
                            ...
                            u = void 0,
                            d = void 0;
                        if (e === E.NEXT ? (c = T.LEFT, u = T.NEXT, d = E.LEFT) : (c = T.RIGHT, u = T.PREV, d = E.RIGHT), a && t(a).hasClass(T.ACTIVE))
                        ...
                        return this.each(function() {
                            ...
                            if (n || (n = new c(this, r), t(this).data(l, n)), "number" == typeof e)
                                n.to(e);
                    ...
                    return h.prototype.toggle = function() {
                        ...
                        if (!this._isTransitioning && t(this._element).hasClass(g.SHOW)) {
                            ...
                            if (t(this._element).trigger(n), !n.isDefaultPrevented()) {
                                ...
                                if (this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", s.reflow(this._element), t(this._element).addClass(g.COLLAPSING).removeClass(g.COLLAPSE).removeClass(g.SHOW), this._triggerArray.length > 0)
                    ...
                    return c.prototype.toggle = function() {
                        if (!this._element.disabled && !t(this._element).hasClass(T.DISABLED)) {
                            var e = c._getParentFromElement(this._element),
                                n = t(this._menu).hasClass(T.SHOW);
                            if (c._clearMenus(), !n) {
                                var i = {
                        ...
                        if (!e || e.which !== m && ("keyup" !== e.type || e.which === _))
                            for (var n = t.makeArray(t(y.DATA_TOGGLE)), i = 0; i < n.length; i++) {
            ...
            var e = "modal",
                ...
                T = function() {
                    ...
                    return c.prototype.toggle = function(t) {
                        ...
                        var n = this,
                            i = s.supportsTransitionEnd() && t(this._element).hasClass(E.FADE);
                        ...
                        var n = this,
                            i = t(this._element).hasClass(E.FADE) ? E.FADE : "";
                        if (this._isShown && this._config.backdrop) {
                            ...
                            }), o && s.reflow(this._backdrop), t(this._backdrop).addClass(E.SHOW), !e)
                                return;
                            if (!o)
                                return void e();
            ...
            var e = "tooltip",
                ...
                I = function() {
                    function c(t, e) {
                        if (n(this, c), "undefined" == typeof Popper)
                    ...
                    return c.prototype.enable = function() {
                        ...
                        var i = this.constructor.DATA_KEY;
                        if (n = n || t(e.currentTarget).data(i), n || (n = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(i, n)), e && (n._activeTrigger["focusout" === e.type ? y.FOCUS : y.HOVER] = !1), !n._isWithActiveTrigger())
        ...
        var e = "scrollspy",
            ...
            E = function() {
                ...
                return c.prototype.refresh = function() {
                    ...
                    var i = t(n.join(","));
                    i.hasClass(p.DROPDOWN_ITEM) ? (i.closest(g.DROPDOWN).find(g.DROPDOWN_TOGGLE).addClass(p.ACTIVE), i.addClass(p.ACTIVE)) : (i.addClass(p.ACTIVE), i.parents(g.NAV_LIST_GROUP).prev(g.NAV_LINKS + ", " + g.LIST_ITEMS).addClass(p.ACTIVE), i.parents(g.NAV_LIST_GROUP).prev(g.NAV_ITEMS).children(g.NAV_LINKS).addClass(p.ACTIVE)), t(this._scrollElement).trigger(_.ACTIVATE, {
                        relatedTarget: e
                    })
        ...
        var e = "zoom",
            ...
            d = function() {
                ...
                return e.prototype._zoom = function(e) {
                    var n = e.target;
                    if (n && "IMG" === n.tagName && !this._$body.hasClass(u.ZOOM_OVERLAY_OPEN))
